...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Nombre del folleto";
			// 
			// label2
			// 
			...
			this->label3->Text = L"Descripcion del folleto";
			...
			this->label4->Text = L"Palabras clave";
			// 
			// label5
			// 
			...
			this->label5->Text = L"Subir folleto";
			// 
			// label6
			// 
			...
			this->label6->Text = L"Ubicación fisica del folleto";
			// 
			// button1
			// 
			...
			this->button2->Text = L"Agregar archivo";

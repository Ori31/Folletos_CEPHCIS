...
namespace $safeprojectname$ {
	...
	private: String^ connectionString = "datasource=localhost; username=root; password=Orion123.;database=login;";
	...
	private: System::Windows::Forms::Button^ btt_invitado;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btt_invitado = (gcnew System::Windows::Forms::Button());
			this->SuspendLayout();
			// 
			// label1
			// 
			...
			this->btn1_sesion->Location = System::Drawing::Point(306, 347);
			this->btn1_sesion->Name = L"btn1_sesion";
			this->btn1_sesion->Size = System::Drawing::Size(188, 27);
			this->btn1_sesion->TabIndex = 1;
			this->btn1_sesion->Text = L"Iniciar sesion";
			...
			// btt_invitado
			// 
			this->btt_invitado->Location = System::Drawing::Point(306, 393);
			this->btt_invitado->Name = L"btt_invitado";
			this->btt_invitado->Size = System::Drawing::Size(188, 28);
			this->btt_invitado->TabIndex = 7;
			this->btt_invitado->Text = L"Acceder como invitado";
			this->btt_invitado->UseVisualStyleBackColor = true;
			this->btt_invitado->Click += gcnew System::EventHandler(this, &MyForm::button1_Click);
			// 
			// MyForm
			// 
			...
			this->Controls->Add(this->btt_invitado);
...
#pragma endregion
	...
	private: System::Void label2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		private: System::Void btn1_sesion_Click(System::Object^ sender, System::EventArgs^ e) {
			...
			String^ sql = "select * from sesion where (Usuarios = `" + txt_usuario->Text + "`) and (Contra = `" + txt_contraseña->Text + "`)";
